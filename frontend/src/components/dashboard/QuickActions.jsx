  ...
  return (
    <div className="glass rounded-[2rem] p-6">
      ...
      <div className="space-y-3">
        ...
        <Link to="/settings" className="block rounded-[1.5rem] border border-border/70 bg-white/70 px-4 py-3 transition hover:border-primary/60 hover:bg-primary/10">Configure cloud or local models</Link>
      </div>
    </div>
  );
}
